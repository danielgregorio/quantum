...
class QueueExecutor(BaseExecutor):
    ...
    def _execute_declare(self, node: QueueNode, queue_name: str, context: Dict[str, Any]) -> Dict:
        ...
        return self.services.message_queue.declare_queue(
            name=queue_name,
            **options
        )
    ...
    def _execute_purge(self, queue_name: str) -> Dict:
        ...
        return self.services.message_queue.purge_queue(queue_name)

    def _execute_delete(self, queue_name: str) -> Dict:
        """Delete a queue."""
        return self.services.message_queue.delete_queue(queue_name)

    def _execute_info(self, queue_name: str) -> Dict:
        """Get queue information."""
        return self.services.message_queue.get_queue_info(queue_name)
