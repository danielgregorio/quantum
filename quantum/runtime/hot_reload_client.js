...
(function() {
    ...
    function scheduleReconnect() {
        if (reconnectAttempts >= MAX_RECONNECT_ATTEMPTS) {
            ...
            showOverlay({
                ...
                message: 'Lost connection to development server.\nPlease restart the server with: quantum start --hot-reload'
            });
            return;
        }
    ...
    function showOverlay(error) {
        ...
        if (isConnectionError) {
            html.push('    Restart the development server with <code style="background:#2a2a2a;padding:2px 6px;border-radius:3px;">quantum start --hot-reload</code>');
        } else {
