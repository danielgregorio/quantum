...
from quantum.core.ast_nodes import (
    ComponentNode, SetNode, LoopNode,
    IfNode, FunctionNode, HTMLNode, TextNode, RedirectNode, FlashNode, DocTypeNode, CommentNode
)
...
class JavaScriptGenerator(CodeGenerator):
    ...
    def visit_FileNode(self, node) -> str:
        ...
        if action == 'upload':
            self.emit('const formData = new FormData();')
