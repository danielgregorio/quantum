...
class PythonGenerator(CodeGenerator):
    ...
    def visit_ComponentNode(self, node: ComponentNode) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import Component, escape, bind')
    ...
    def visit_ApplicationNode(self, node: ApplicationNode) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import Component, escape')
    ...
    def visit_QueryNode(self, node: QueryNode) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import Database')
    ...
    def visit_ActionNode(self, node: ActionNode) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import request, redirect, flash')
    ...
    def visit_RedirectNode(self, node: RedirectNode) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import redirect')
    ...
    def visit_FlashNode(self, node: FlashNode) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import flash')
    ...
    def visit_DataNode(self, node) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import load_data')
    ...
    def visit_InvokeNode(self, node) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import invoke')
    ...
    def visit_FileNode(self, node) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import handle_file')
    ...
    def visit_MailNode(self, node) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import send_mail')
    ...
    def visit_JobNode(self, node) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import JobQueue')
    ...
    def visit_ScheduleNode(self, node) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import Scheduler')
    ...
    def visit_ThreadNode(self, node) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import AsyncThread')
    ...
    def visit_ParallelNode(self, node) -> str:
        ...
        self.imports.add('from quantum.compiler.python.runtime import parallel_execute')
