...
def handle_pkg(args: argparse.Namespace) -> int:
    ...
    try:
        from quantum.packages import PackageManager, PackageError
    except ImportError:
        # Try relative import
        from quantum.packages import PackageManager, PackageError
...
def _handle_init(pm, args: argparse.Namespace) -> int:
    ...
    print()
    print("Next steps:")
    print("   1. Edit src/index.q to create your component")
    print("   2. Update quantum.yaml with description and keywords")
...
def _handle_publish(pm, args: argparse.Namespace) -> int:
    ...
    print("[SUCCESS] Package archive created!")
