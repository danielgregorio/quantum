...
class SceneNode(QuantumNode):
    ...
    VALID_DEATH_SEQUENCES = ('classic', 'instant', 'respawn')
    ...
    def __init__(self, name: str):
        ...
        # Death / game over
        self.death_sequence: Optional[str] = None  # "classic", "instant", "respawn"
...
class SpriteNode(QuantumNode):
    ...
    def __init__(self, sprite_id: str):
        ...
        # Special abilities
        self.spin_jump: bool = False  # classic spin jump (kills enemies instantly, rotates sprite)
...
class HudNode(QuantumNode):
    ...
    def __init__(self):
        ...
        self.sprite_prefix: Optional[str] = None  # e.g. "assets/classic/sprites/hud_"
        self.children: List[QuantumNode] = []
...
class MapNodeDef(QuantumNode):
    ...
    that the player can move between (classic-style world map).
...
class MapPathNode(QuantumNode):
    ...
    Defines connectivity in the world map graph. Hero can only
