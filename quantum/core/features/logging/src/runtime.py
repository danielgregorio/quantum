...
class LoggingService:
    ...
    @classmethod
    def configure_from_external(cls, logger):
        """
        Inject an externally configured logger so q:log tags reuse
        the same handlers without duplication.

        Called by logging_setup.setup_logging() after configuring
        the 'quantum' root logger.
        """
