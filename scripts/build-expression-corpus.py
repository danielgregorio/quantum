...
def main():
    ...
    print(f"{len(corpus)} unique expressions")
    print(f"  {ok} evaluated without an exception")
    print(f"  {len(corpus)-ok} raised an exception")
    print(f"  {unresolved} returned the literal placeholder (did not resolve)")
