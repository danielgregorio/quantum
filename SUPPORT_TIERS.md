# Quantum — Support tiers

> Updated for 1.0 (2026-09-24). Earlier revisions: 2026-09-10 (the *Flawless core*
> plan's decisions — authentication in Core; games and AS4 stay in the repository as
> Laboratory) and 2026-09-07 (the first cut, from the functional audit of
> September 2026, which ran every documented feature).
>
> This document is **policy** — what the project promises. The real state of each
> feature (does it run today or not) is `FEATURE_STATUS.md`, which is generated by
> running the examples, never edited by hand. Both exist because promise and reality
> drifted apart for months, and that drift was the audit's central finding.
>
> The engine enforces these lists: `quantum/core/tiers.py` is the code version of this
> page, and a tag outside Core and AI warns once when it is used.
