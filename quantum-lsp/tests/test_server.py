...
class TestSchema:
    ...
    def test_required_attributes(self):
        ...
        # q:query NAO exige 'name'. Uma query de ESCRITA nao tem resultado
        # para ligar a variavel nenhuma — o proprio parser do framework diz
        # isso ("A write query (UPDATE/INSERT/DELETE) has no result set to
        # bind") e nao levanta sem o atributo. Os quatro <q:query> sem name
        # do repositorio sao todos UPDATE ou DELETE.
        #
        # Este teste afirmava que era obrigatorio, codificando a crenca do
        # esquema em vez do comportamento do framework — e por causa dela o
        # servidor acusava 31 vezes codigo correto.
