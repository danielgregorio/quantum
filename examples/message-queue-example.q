...
<q:component xmlns:q="https://quantum.lang/ns" name="MessageQueueExample">
    ...
    <q:action name="createOrder">
        <q:query name="order" datasource="db">
            ...
            <q:param name="customerId" value="{form.customerId}" type="integer" />
            <q:param name="items" value="{form.items}" type="string" />
            <q:param name="total" value="{form.total}" type="decimal" />
        </q:query>
