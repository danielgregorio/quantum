<q:component name="RAGDemo">
    ...
    <q:knowledge name="docs" embedModel="nomic-embed-text" chunkSize="300" chunkOverlap="30">
        <q:source type="text">
    ...
    <q:if condition="{form.question}">
        ...
        <q:llm name="answer" model="phi3" knowledge="docs" top="3">
    ...
    <div class="rag-container">
        ...
        <q:if condition="{hasQuestion} == 1">
            ...
            <div class="answer-card">
                ...
                <span class="confidence-badge">Cites sources: {answer_result.cited}</span>
            </div>
