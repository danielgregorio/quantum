...
<q:application id="ThemePresetsDemo" type="ui" theme="dark" auto-switch="true">
    ...
    <ui:window title="Theme Presets Gallery">
        <ui:vbox padding="lg" gap="lg">
            ...
            <!-- Theme Switcher -->
            <ui:hbox gap="sm">
                <ui:button variant="primary" on-click="window.__quantumSetTheme('light')">Light</ui:button>
                <ui:button variant="secondary" on-click="window.__quantumSetTheme('dark')">Dark</ui:button>
                <ui:button variant="secondary" on-click="window.__quantumSetTheme('high-contrast')">High Contrast</ui:button>
                <ui:button variant="secondary" on-click="window.__quantumSetTheme('sepia')">Sepia</ui:button>
                <ui:button variant="secondary" on-click="window.__quantumSetTheme('nord')">Nord</ui:button>
                <ui:button variant="secondary" on-click="window.__quantumSetTheme('dracula')">Dracula</ui:button>
            </ui:hbox>
