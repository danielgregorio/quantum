...
<q:application id="super-mario-world" type="game" engine="2d">
  ...
  <qg:prefab name="coin" entity-type="item" collectible="true" reward="score:10">
    <qg:sprite id="coin_body" src="assets/smw/sprites/coin_animated.png"
  ...
  <qg:prefab name="rex" entity-type="enemy" movement="patrol" move-speed="30"
    ...
    <qg:sprite id="rex_body" src="assets/smw/sprites/rex_walk.png"
  ...
  <qg:prefab name="qblock" entity-type="block" content="coin" hits="1">
    <qg:sprite id="qblock_body" src="assets/smw/sprites/qblock_animated.png"
               frame-width="16" frame-height="16"
  ...
  <qg:prefab name="rotating_block" entity-type="block" breakable="true">
    <qg:sprite id="rb_body" src="assets/smw/sprites/rotating_block.png"
               tag="rotating_block" body="static" />
  </qg:prefab>

  <!-- Yoshi coin: special collectible with shimmer effect -->
  <qg:prefab name="yoshi_coin" entity-type="item" collectible="true" reward="score:50">
    <qg:sprite id="yc_body" src="assets/smw/sprites/yoshi_coin.png"
               frame-width="16" frame-height="16"
  ...
  <qg:prefab name="checkpoint" entity-type="goal" checkpoint="true">
    <qg:sprite id="cp_body" src="assets/smw/sprites/checkpoint_gate.png"
               tag="checkpoint" body="static" sensor="true" />
  </qg:prefab>

  <!-- Mushroom: powerup item, moves after spawning -->
  <qg:prefab name="mushroom">
    <qg:sprite id="mush_body" src="assets/smw/sprites/mushroom.png"
               width="16" height="16"
  ...
  <qg:prefab name="banzai_bill" entity-type="enemy">
    <qg:sprite id="bb_body" src="assets/smw/sprites/banzai_bill.png"
  ...
  <qg:prefab name="piranha_plant" entity-type="hazard">
    <qg:sprite id="pp_body" src="assets/smw/sprites/piranha_plant.png"
               frame-width="16" frame-height="16"
  ...
  <qg:prefab name="flying_qblock" entity-type="block" flying="true" content="mushroom" hits="1">
    <qg:sprite id="fqb_body" src="assets/smw/sprites/qblock_animated.png"
               frame-width="16" frame-height="16"
               tag="qblock" body="static">
      <qg:animation name="shine" frames="0,1,2,3" speed="0.15" loop="true" auto-play="true" />
    </qg:sprite>
  ...
  <!-- Title screen (inline - simple) -->
  <qg:scene name="title" type="title" initial="true"
            width="256" height="224" viewport-width="256" viewport-height="224"
            background="#000000">
    <qg:sprite id="title-bg" src="assets/smw/sprites/title_bg.png"
               x="128" y="112" width="256" height="224" />

    <qg:input key="Enter" action="press-start" />
