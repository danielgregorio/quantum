...
-->
<qg:scene name="yoshi-island-1" type="level"
          width="5120" height="432"
          viewport-width="256" viewport-height="224"
          background="#5C94FC"
          death-sequence="smw" death-timer="3.0"
          game-over-jingle="assets/smw/sounds/smw_game_over.wav"
          game-over-alphabet="assets/smw/sprites/hud_alphabet.png">
  ...
  <!-- ============================================================ -->
  <qg:tilemap id="terrain" src="assets/smw/collision_tileset.tres"
              data-src="assets/smw/tile_map.json"
