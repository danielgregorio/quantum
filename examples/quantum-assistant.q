<q:component name="QuantumAssistant" xmlns:q="https://quantum.lang/ns">
  ...
  <q:knowledge name="quantum" embedModel="nomic-embed-text"
  ...
  <q:if condition="{form.question}">
    ...
    <!-- Answer from the knowledge base, citing its sources (IA-6) -->
    <q:llm name="answer" model="phi3" knowledge="quantum" top="5">
    ...
    <q:if condition="{form.question}">
      ...
      <div class="answer-card">
        ...
        <div class="answer-meta">
          <span class="badge badge-confidence">Grounded: {answer_result.grounded}</span>
          <span class="badge badge-source">Cites sources: {answer_result.cited}</span>
        </div>
      </div>
