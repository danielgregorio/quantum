...
<!--
  ...
  Run:
    ...
    quantum run examples/agent_multi_provider.q

    # Using OpenAI (requires: OPENAI_API_KEY env var)
    export OPENAI_API_KEY="sk-..."
    quantum run examples/agent_multi_provider.q  (provider=openai)

    # Using Anthropic (requires: ANTHROPIC_API_KEY env var)
    export ANTHROPIC_API_KEY="sk-ant-..."
    quantum run examples/agent_multi_provider.q  (provider=anthropic)
-->
