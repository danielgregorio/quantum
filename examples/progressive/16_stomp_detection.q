...
<!--
  Phase 16: Stomp Detection (Simplified)

  Tests:
  - Enemies can be destroyed on any collision
  - Simplified version - full stomp logic would need engine support
-->
<q:application id="stomp-detection" type="game" engine="2d">
...
14,14,14,14,14,14,14,14,14,14,14,14,14,14,14,14
    ...
    <!-- Enemies -->
    <qg:instance prefab="enemy" id="enemy1" x="120" y="80" />
    <qg:instance prefab="enemy" id="enemy2" x="170" y="80" />
    ...
    <qg:hud position="top-center">
      <div style="color: #fff; font-family: monospace; font-size: 8px;">
