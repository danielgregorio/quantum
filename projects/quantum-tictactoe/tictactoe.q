  ...
  <qg:behavior name="Cell">
    ...
    <q:function name="onCellClick">
      <q:if condition="{self.mark === '' &amp;&amp; currentTurn === 'X'}">
        ...
        <q:set name="moves" value="{moves + 1}" />
        <q:set name="currentTurn" value="O" />
        <q:set name="turnLabel" value="O's turn" />
      </q:if>
      <q:if condition="{self.mark === '' &amp;&amp; currentTurn === 'O'}">
        <q:set name="self.mark" value="O" />
        <q:set name="moves" value="{moves + 1}" />
        <q:set name="currentTurn" value="X" />
        <q:set name="turnLabel" value="X's turn" />
      </q:if>
    </q:function>
  </qg:behavior>
