<q:component name="Styles">
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .post-content .text { white-space: pre-line; }
    ...
    .admin-table th { background: #f8fafc; color: #64748b; font-weight: 600; }
    ...
    .link-button { background: none; border: none; color: var(--primary); cursor: pointer; font: inherit; padding: 0 6px; }
    .link-button.danger { color: var(--danger); }
    .panel { background: #fff; border-radius: 12px; padding: 24px; margin-bottom: 24px; }
    .panel input, .panel textarea, .panel select { width: 100%; padding: 10px 12px; border: 1px solid #e2e8f0; border-radius: 8px; font: inherit; margin-bottom: 12px; }
    .panel textarea { min-height: 160px; }
