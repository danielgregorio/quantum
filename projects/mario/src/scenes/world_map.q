...
<qg:scene name="world-map" type="map"
  ...
  <!-- Map background -->
  <qg:sprite id="map-bg" src="assets/sprites/world1_map.png"
             x="256" y="256" width="512" height="512" />

  <!-- Mario sprite on map -->
  <qg:sprite id="mario" src="assets/sprites/mario_map.png"
             x="32" y="180" width="16" height="16" />

  <!-- Background music -->
  <qg:sound id="bgm-map" src="assets/sounds/music/music-map1.wav"
  ...
  <qg:map-node id="yoshi-island-1" x="80" y="180" scene="yoshi-island-1"
               icon="assets/sprites/level_dot.png" />
  <qg:map-node id="yoshi-island-2" x="128" y="160" scene="yoshi-island-2"
               locked="true" icon="assets/sprites/level_dot.png" />
  <qg:map-node id="castle-1" x="200" y="140" scene="castle-1"
               locked="true" icon="assets/sprites/castle_icon.png" />
