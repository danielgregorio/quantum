    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if dockerfile_src.exists():
                ...
                legacy_dockerfile = Path('/home/user/quantum-deploy/Dockerfile')
            ...
            if requirements_src.exists():
                ...
                # Fallback to legacy path
                legacy_requirements = Path('/home/user/quantum-deploy/requirements.txt')
            ...
            if src_dir.exists():
                ...
                # Fallback to legacy path
                legacy_src = Path('/home/user/quantum-deploy/src')
