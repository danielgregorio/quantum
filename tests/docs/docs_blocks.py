...
PARSE_ONLY_PAGES = {
    ...
    'guide/getting-started.md', 'guide/how-a-page-runs.md', 'guide/installation.md', 'guide/project-structure.md', 'guide/query.md', 'guide/quick-start.md',
    'guide/services.md', 'guide/sessions.md', 'guide/testing.md',
    'guide/ui.md',
