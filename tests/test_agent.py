...
from quantum.runtime.agent_service import (
    AgentService, AgentResult, ToolCall, reset_agent_service
)
...
<q:component name="Test" xmlns:q="urn:quantum">
    ...
    def test_parse_agent_with_multiple_tools(self, parser):
        ...
        xml = '''<?xml version="1.0"?>
<q:component name="Test" xmlns:q="urn:quantum">
    <q:agent name="support" model="mistral" maxIterations="10" timeout="30000">
...
class TestAgentIntegration:
    ...
    def mock_llm_response(self):
        ...
        with patch('quantum.runtime.agent_service.AgentService.llm_service') as mock:
