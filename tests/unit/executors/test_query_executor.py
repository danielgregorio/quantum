...
from quantum.runtime.executors.data.query_executor import QueryExecutor
...
class TestQueryParameters:
    ...
    def test_query_with_string_param(self):
        ...
        with patch('quantum.runtime.query_validators.QueryValidator') as MockValidator:
    ...
    def test_query_param_validation_error(self):
        ...
        with patch('quantum.runtime.query_validators.QueryValidator') as MockValidator:
            from quantum.runtime.query_validators import QueryValidationError
