...
from quantum.runtime.executors.data.data_executor import DataExecutor
...
class TestCSVImport:
    ...
    def test_import_csv_with_columns(self):
        ...
        # DATA-1: a q:column is a name and a type; required/default were never applied
        assert set(params["columns"][0]) == {"name", "type"}
