...
CONFIG = {"llm": {"base_url": "http://10.10.1.40:11434",
...
class TestBothPathsUseTheConfiguredHost:
    def test_multi_llm_honours_base_url(self):
        ...
        assert _norm(sc.multi_llm.default_endpoint) == "http://10.10.1.40:11434"

    def test_llm_service_honours_base_url(self):
        sc = ServiceContainer(CONFIG)
        assert _norm(sc.llm.base_url) == "http://10.10.1.40:11434"
