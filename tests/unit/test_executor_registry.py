...
class TestExecutorRegistry:
    ...
    def test_execute_raises_for_unknown_type(self):
        ...
        from quantum.runtime.executor_registry import ExecutorRegistry, ExecutorNotFoundError
...
class TestDataExecutors:
    ...
    def test_data_executor_handles_data_node(self):
        ...
        from quantum.runtime.executors.data import DataExecutor
        from quantum.core.ast_nodes import DataNode
...
class TestMessagingExecutors:
    ...
    def test_websocket_executor_handles_websocket_node(self):
        ...
        from quantum.runtime.executors.messaging import WebSocketExecutor
        from quantum.core.features.websocket.src.ast_node import WebSocketNode
    ...
    def test_message_executor_handles_message_node(self):
        ...
        from quantum.runtime.executors.messaging import MessageExecutor
        from quantum.core.ast_nodes import MessageNode
...
class TestScriptingExecutors:
    ...
    def test_pyimport_executor_handles_pyimport_node(self):
        ...
        from quantum.runtime.executors.scripting import PyImportExecutor
        from quantum.core.ast_nodes import PyImportNode
