...
class TestMultiProviderLLMService:
    ...
    @patch('quantum.runtime.llm_providers.OllamaProvider.chat')
    ...
    @patch('quantum.runtime.llm_providers.OpenAIProvider.chat')
    ...
    @patch('quantum.runtime.llm_providers.OllamaProvider.generate')
...
class TestAgentServiceIntegration:
    ...
    def agent_service(self):
        ...
        from quantum.runtime.agent_service import AgentService, reset_agent_service
        reset_agent_service()
        return AgentService()
