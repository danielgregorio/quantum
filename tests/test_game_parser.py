...
from quantum.core.features.game_engine_2d.src.ast_nodes import (
    SceneNode, SpriteNode, PhysicsNode, InputNode, SoundNode, HudNode, BehaviorNode, UseNode,
    PrefabNode, InstanceNode, GroupNode, TilemapNode,
    StateMachineNode, StateNode, ClickableNode,
    EventNode,
    ...
    EnemyNode, EnemyAiNode, EnemyDefeatNode,
)
...
class TestPrefabSemanticParsing:
    ...
    def test_enemy_prefab_full(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:prefab name="Walker" type="enemy" health="2" defeated-by="stomp"
                ...
                <qg:sprite src="walker.png" body="dynamic" tag="enemy" />
            </qg:prefab>
            <qg:scene name="main" width="800" height="600">
                <qg:sprite id="p" src="p.png" x="0" y="0" />
            </qg:scene>
    ...
    def test_block_prefab(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:prefab name="QuestionBlock" type="block" content="mushroom"
                ...
                <qg:sprite src="item_block.png" body="static" tag="block" />
            </qg:prefab>
            <qg:scene name="main" width="800" height="600">
                <qg:sprite id="p" src="p.png" x="0" y="0" />
            </qg:scene>
    ...
    def test_respawn_attributes(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:prefab name="Patroller" type="enemy" health="1" defeated-by="stomp"
                       respawns="true" respawn-delay="5.0">
                <qg:sprite src="patroller.png" body="dynamic" tag="enemy" />
            </qg:prefab>
            <qg:scene name="main" width="800" height="600">
                <qg:sprite id="p" src="p.png" x="0" y="0" />
            </qg:scene>
...
class TestHudTileBasedParsing:
    ...
    def test_hud_tile(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:scene name="main" width="256" height="224">
                <qg:hud background="rgba(0,0,0,0.5)" background-height="26">
                    <qg:tile sprite="hero_text.png" x="24" y="8" />
                </qg:hud>
                <qg:sprite id="p" src="p.png" x="0" y="0" />
            </qg:scene>
        </q:application>'''
        ...
        assert tile.sprite == 'hero_text.png'
        assert tile.x == 24
        assert tile.y == 8
            ...
            <qg:scene name="main" width="256" height="224">
                <qg:hud background="rgba(0,0,0,0.5)">
                    <qg:collection sprite="coin.png" x="148" y="8"
                                   spacing="8" max="5" bind="{bonus_coins}" />
                </qg:hud>
                <qg:sprite id="p" src="p.png" x="0" y="0" />
            </qg:scene>
        </q:application>'''
    ...
    def test_hud_sprite_prefix(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:scene name="main" width="256" height="224">
                <qg:hud sprite-prefix="assets/hud_" background="rgba(0,0,0,0.5)">
                    <qg:tile sprite="hero.png" x="0" y="0" />
        ...
        assert hud.children[0].sprite == 'hero.png'
...
class TestMultiSceneApplication:
    ...
    def test_multiple_scenes_with_types(self, parser):
        src = '''<q:application id="hero" type="game" engine="2d">
            <qg:persistent>
                <q:set name="lives" value="5" type="integer" />
            </qg:persistent>
            <qg:scene name="title" type="title" initial="true" width="256" height="224">
            ...
            <qg:scene name="level-1" type="level" width="5120" height="432">
                <qg:sprite id="player" src="hero.png" x="32" y="350" />
                <qg:event name="level-complete">
...
class TestSpriteCollisionLayerParsing:
    ...
    def test_sprite_collision_layer_and_mask(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:scene name="main" width="800" height="600">
                <qg:sprite id="hero" src="hero.png" x="0" y="0"
...
class TestPrefabTurnCooldownParsing:
    ...
    def test_prefab_turn_cooldown(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:scene name="main" width="800" height="600">
                <qg:prefab name="walker" type="enemy" movement="patrol"
                           turn-cooldown="0.15">
                    <qg:sprite id="walker_body" src="walker.png" tag="enemy" body="dynamic" />
                </qg:prefab>
            </qg:scene>
        </q:application>'''
        ast = parser.parse(src)
    ...
    def test_prefab_turn_cooldown_default_none(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:scene name="main" width="800" height="600">
                <qg:prefab name="patroller" type="enemy" movement="patrol">
    ...
    def test_scene_death_sequence(self, parser):
        ...
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:scene name="level-1" type="level"
                       death-sequence="classic" death-timer="3.5"
        ...
        ast = parser.parse(src)
        scene = ast.scenes[0]
        assert scene.death_sequence == 'classic'
    ...
    def test_enemy_with_instance_placement(self, parser):
        src = '''<q:application id="g" type="game" engine="2d">
            <qg:scene name="main" width="800" height="600">
                ...
                <qg:instance prefab="walker" id="walker1" x="416" y="370" />
                <qg:instance prefab="walker" id="walker2" x="560" y="370" />
            </qg:scene>
        </q:application>'''
        ast = parser.parse(src)
        scene = ast.scenes[0]
        ...
        assert len(enemies) == 1
        assert len(instances) == 2
        assert enemies[0].prefab == 'walker'
        assert instances[0].prefab == 'walker'
