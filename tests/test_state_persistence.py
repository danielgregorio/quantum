...
# NOTE: this module used to os.chdir() into src/ at import time and never
# restore it, silently changing the working directory for every test that ran
# after it — that is what made cwd-relative fixtures elsewhere in the suite
# fail only when run as part of the full run. The package move removed the
...
class TestDesktopPersistence:
    ...
    def test_quantum_state_has_persistence_methods(self):
        ...
        from quantum.runtime.ui_desktop_templates import QUANTUM_STATE_CLASS
    ...
    def test_quantum_api_accepts_persist_config(self):
        ...
        from quantum.runtime.ui_desktop_templates import QUANTUM_API_CLASS
