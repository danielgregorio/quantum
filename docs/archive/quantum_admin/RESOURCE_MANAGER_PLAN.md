...
class PortAllocation(Base):
    ...
    host = Column(String(255), default='localhost')  # localhost, forge, localhost
...
│  ┌─── Service Health ─────────────────────────────────────────┐│
│  │                                                             ││
│  │  ● quantumblog-prod    http://localhost:8080/health  120ms││
│  │  ● quantumblog-staging http://localhost:8082/health   95ms││
│  │  ○ quantumblog-dev     http://localhost:8081/health  [N/A]││
│  │  ● blog-db             tcp://localhost:5432          45ms ││
│  │                                                             ││
