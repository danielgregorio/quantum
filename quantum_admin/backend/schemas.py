...
class DatasourceUpdate(BaseModel):
    ...
    # Connection data. This schema existed without these fields and without ANY
    # route that used it: you could create and delete a datasource, never
    # fix it. Getting the host or the password wrong meant deleting and
    # recreating — the most visible hole in the admin's core (ADMIN_STATUS.md).
    host: Optional[str] = None
    port: Optional[int] = Field(None, ge=1, le=65535)
    database_name: Optional[str] = None
    username: Optional[str] = None
    password: Optional[str] = None      # cifrada antes de gravar
