...
class DatasourceUpdate(BaseModel):
    ...
    # Dados de conexão. Este schema existia sem estes campos e sem NENHUMA
    # rota que o usasse: dava para criar e excluir um datasource, nunca
    # corrigi-lo. Errar o host ou a senha significava excluir e recriar — o
    # buraco mais visível do núcleo do admin (ADMIN_STATUS.md).
    host: Optional[str] = None
