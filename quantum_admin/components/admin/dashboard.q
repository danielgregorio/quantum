<q:component name="AdminDashboard" require_auth="true" require_role="admin" login_url="/admin/login">
  <!--
    Numbers of the repository, measured by admin.dashboard.stats
    (quantum_admin/services/repository.py). The previous version looked in
    src/core/... and showed 0 features, 0 parsers and 0 executors.
  -->
      ...
      <div class="qa-card">
        <div class="qa-card-header">
          <div>
            ...
            <div class="qa-card-subtitle">{len(catalog.features)} feature modules</div>
          </div>
        </div>
        <div class="qa-card-body" style="max-height: 360px; overflow-y: auto;">
