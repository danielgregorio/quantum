<q:component name="AdminShell" require_auth="true" require_role="admin" login_url="/admin/login">
  <!--
    Frame of the admin screens: sidebar, header and messages.
    Use on a screen:
    ...
    The content is rendered in the screen's scope (COMP-3). Before, the 16 screens
    repeated this whole sidebar, each with its own copy.
  -->
