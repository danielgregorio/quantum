#!/usr/bin/env python3
"""
Benchmark: CPython vs PyPy for Quantum
========================================
...
def benchmark_loop_quantum(iterations: int = 1000):
    """Expression evaluation benchmark in a loop (simulates a Quantum loop)."""
    from runtime.expression_cache import get_expression_cache
    ...
    for _ in range(iterations):
        context = {'total': 0}
        for i in range(100):
            # Simulates what Quantum does internally on each iteration
            context['i'] = i
